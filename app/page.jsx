    ...
    <section className="py-20 bg-blue-50">
     ...
     <section className="py-20">
      ...
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold text-white mb-4">Ready to Take Control of Your Finance</h2>
        <p className="text-lue-100 mb-8 max-w-2xl mx-auto">
       ...
       <Link href="/dashboard">
        <Button
        size="lg"
        className="mg-white text-blue-600 hover:bg-blue-50
        animate-bounce">
          Start Free Trail
        </Button></Link>
